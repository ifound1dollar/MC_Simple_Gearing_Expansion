...
public class ModInfusedDiamondShovelItem extends ShovelItem {
    public ModInfusedDiamondShovelItem(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
