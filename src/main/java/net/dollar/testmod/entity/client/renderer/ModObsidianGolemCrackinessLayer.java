...
@OnlyIn(Dist.CLIENT)
public class ModObsidianGolemCrackinessLayer extends RenderLayer<ObsidianGolemEntity, IronGolemModel<ObsidianGolemEntity>> {
    private static final Map<IronGolem.Crackiness, ResourceLocation> resourceLocations = ImmutableMap.of(
            IronGolem.Crackiness.LOW, new ResourceLocation(TestMod.MOD_ID, "textures/entities/obsidian_golem_crackiness_low.png"),
            IronGolem.Crackiness.MEDIUM, new ResourceLocation(TestMod.MOD_ID, "textures/entities/obsidian_golem_crackiness_medium.png"),
            IronGolem.Crackiness.HIGH, new ResourceLocation(TestMod.MOD_ID, "textures/entities/obsidian_golem_crackiness_high.png"));

    public ModObsidianGolemCrackinessLayer(RenderLayerParent<ObsidianGolemEntity, IronGolemModel<ObsidianGolemEntity>> p_117135_) {
        super(p_117135_);
    }
