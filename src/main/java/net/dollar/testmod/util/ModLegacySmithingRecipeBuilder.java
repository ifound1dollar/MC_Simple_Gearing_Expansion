...
public class ModLegacySmithingRecipeBuilder {
    ...
    public ModLegacySmithingRecipeBuilder(RecipeSerializer<?> p_266753_, Ingredient p_267080_, Ingredient p_267246_, RecipeCategory p_267024_, Item p_266767_) {
    ...
    public void save(Consumer<FinishedRecipe> p_266852_, ResourceLocation p_267253_) {
        ...
        p_266852_.accept(new ModLegacySmithingRecipeBuilder.Result(p_267253_, this.type, this.base, this.addition, this.result, this.advancement, p_267253_.withPrefix("recipes/" + this.category.getFolderName() + "/")));
    }
