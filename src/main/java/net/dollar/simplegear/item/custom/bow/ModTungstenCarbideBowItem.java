...
/**
 * Class corresponding specifically to the Tungsten-Carbide Bow Item, derived directly from BowItem.
 */
public class ModTungstenCarbideBowItem extends BowItem {
    public static final int MAX_DRAW_DURATION = 24;
    public static final int DEFAULT_RANGE = 15;


    public ModTungstenCarbideBowItem(Properties properties) {
        super(properties);
    }
    ...
    /**
     * Allows modifying or replacing the AbstractArrow generated on weapon release. Here, modifies generated
     *  Arrow's base damage.
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        components.add(Component.literal("§8> +50% damage"));
        components.add(Component.literal("§8> Draws 20% slower"));
