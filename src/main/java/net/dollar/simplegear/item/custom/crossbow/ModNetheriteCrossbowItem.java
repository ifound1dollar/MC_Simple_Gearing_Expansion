...
/**
 * Class corresponding specifically to the Netherite Crossbow Item. Derived from CrossbowItem but implements
...
public class ModNetheriteCrossbowItem extends CrossbowItem {
    ...
    public ModNetheriteCrossbowItem(Properties properties) {
        super(properties);
    }
