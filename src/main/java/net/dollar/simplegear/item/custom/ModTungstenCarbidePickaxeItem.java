...
/**
 * Used specifically for the Tungsten-Carbide Pickaxe, which has custom on-hit effect chance, is fire
 *  and explosion resistant, and has custom hover text.
 */
public class ModTungstenCarbidePickaxeItem extends PickaxeItem {
    public ModTungstenCarbidePickaxeItem(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
