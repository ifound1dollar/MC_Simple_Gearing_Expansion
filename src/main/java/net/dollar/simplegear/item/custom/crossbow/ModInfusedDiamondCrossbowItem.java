...
/**
 * Class corresponding specifically to the Infused Diamond Crossbow Item. Derived from CrossbowItem but implements
 ...
 */
public class ModInfusedDiamondCrossbowItem extends CrossbowItem implements IInfusedDiamondItem {
    private static final String TAG_CHARGED = "Charged";
    private static final String TAG_CHARGED_PROJECTILES = "ChargedProjectiles";
    private static final int MAX_CHARGE_DURATION = 20;
    ...
    public ModInfusedDiamondCrossbowItem(Properties properties) {
        super(properties);
    }
