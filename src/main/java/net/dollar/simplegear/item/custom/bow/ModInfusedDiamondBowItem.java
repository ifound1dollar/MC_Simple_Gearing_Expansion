...
/**
 * Class corresponding specifically to the Infused Diamond Bow Item, derived directly from BowItem.
 */
public class ModInfusedDiamondBowItem extends BowItem implements IInfusedDiamondItem {
    public static final int MAX_DRAW_DURATION = 16;
    public static final int DEFAULT_RANGE = 15;


    public ModInfusedDiamondBowItem(Properties properties) {
        super(properties);
    }
