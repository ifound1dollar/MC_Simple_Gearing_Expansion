...
public class ModTileEntities {
    ...
    public static final RegistryObject<BlockEntityType<ModSpectralLanternBlockEntity>> SPECTRAL_LANTERN_TILE =
            TILE_ENTITY_TYPES.register("spectral_lantern",
            () -> BlockEntityType.Builder.of(ModSpectralLanternBlockEntity::new, ModBlocks.SPECTRAL_LANTERN.get())
                    .build(null));
